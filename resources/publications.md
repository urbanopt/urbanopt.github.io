...
- Robert Flores, Khanh Nguyen Cu, Sammy Houssainy, Weixi Wang, Xiao Nie, Noah Woolfolk, Ben Polly, Ramin Faramarzi, Jim Maclay, Jaeho Lee, Jack Brouwer (2025). [Active and passive cooling approaches for a Southern California residential community.](https://www.sciencedirect.com/science/article/pii/S2666792425000289) Advances in Applied Energy, Volume 19, 100234, ISSN 2666-7924.

- Amy Allen, Jing Wang, Shadi Abdel Haleem, Matt Mitchell, Nicholas Long, Gregor Henze, and Jay Tulley (2025). [From Theory to Practice: Feasibility Study of a Thermal Microgrid at a DoD Installation.](https://docs.nlr.gov/docs/fy25osti/92878.pdf) Preprint. 2025 ASHRAE Annual Conference.

- Simpson, Juliet G., Nicholas Long, and Whitney Trainor-Guitton (2025). [Electrical and Thermal Load Impacts of Three District Heating and Cooling Designs for an Existing Community in Washington, DC.](https://docs.nlr.gov/docs/fy26osti/95498.pdf) Preprint. 2025 Geothermal Rising Conference.

- Sebastian Zwickl-Bernhard, Nicholas Long, Simon Jordan, Felix Bauer, Juliet G. Simpson, Whitney Trainor-Guitton (2025). [Optimizing district energy systems under uncertainty: Insights from a case study from Washington D.C., USA.](https://www.sciencedirect.com/science/article/pii/S2210670726002350) Energy Conversion and Management, Volume 341, 119979, ISSN 0196-8904.
...
- El Kontar, Rawad, Joseph Robertson, Khanh Nguyen Cu, Alexandra Grayson, Jiazhen Ling, Hanna Sotiropoulos, and Tarek Rakha (2024). [An Open-Source Framework for Characterizing Urban Energy Models: Integrating Top-Down and Bottom-Up Methods to Predict Residential Buildings Characteristics.](https://docs.nlr.gov/docs/fy24osti/90883.pdf) Preprint. ACEEE Summer Study on Energy Efficiency in Buildings.

- Wang, Jing, Matt Mitchell, Tanushree Charan, Brian Ball, Nathan Moore, Shadi Abdel Haleem (2024). [Development of a sizing and modeling platform for district energy systems with geothermal heat pumps.](https://openresearch.okstate.edu/entities/publication/6f68a372-69ce-4060-b3b6-0aff0d9ef329) Research Conference Proceedings of the IGSHPA.
...
- Kaiyu Sun, Wanni Zhang, David Goldwasser, Tanushree Charan, Katherine Fleming, Lauren Klun, Ben Polly, Tianzhen Hong (2023) [Development of Prototypical District-Scale Models.](https://www.nlr.gov/docs/fy23osti/86589.pdf) Preprint. IBPSA Conference and Exhibition, Building Simulation 2023
...
- Lämmle, M., Allen, A., Henze, G., Pless, S. (2022). [Valuation of Novel Waste Heat Sources and a Path Towards Adoption](https://www.nlr.gov/docs/fy22osti/83352.pdf). Preprint. ACEEE Summer Study on Energy Efficiency in Buildings.

- Zahra Fallahi, P., Houssainy, S., Ling, J., Leach, M., Klun, L., Slovensky, M. (2022). [Designing for Zero Energy and Zero Carbon on a Multi-Building Scale using URBANopt](https://www.nlr.gov/docs/fy22osti/83457.pdf). Preprint. ACEEE Summer Study on Energy Efficiency in Buildings.
...
- Allen, A., Long, N. L., Moore, N., & Elarga, H. (2021). [URBANopt District Energy Systems HVAC Measures.](https://doi.org/10.11578/dc.20210127.1). National Laboratory of the Rockies.
