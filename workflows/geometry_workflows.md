...
[create_bar_from_building_type_ratios](https://github.com/NatLabRockies/openstudio-model-articulation-gem/tree/develop/lib/measures/create_bar_from_building_type_ratios)
...
file and can be taken from the standard space type templates. Visit the link for one of the [web tools to create FloorSpaceJS](https://natlabrockies.github.io/floorspace.js/) files.
